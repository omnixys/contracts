...
> Repository development instructions for **contracts** (Shared Package).
> Stack: ts-package. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys transport-neutral DTOs, enums, schemas, and domain errors.
...
src/{schemas, errors, dtos, enums, types, analytics}
