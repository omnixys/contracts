...
import type { EventPermissionCategory, EventPermissionKey } from '../enums/event-permission-key.enum.js';
...
export type EventMilestoneType = "INVITATION_CREATED" | "INVITATION_APPROVED" | "TICKET_GENERATED" | "TICKET_REVOKED" | "TICKET_SCANNED";
