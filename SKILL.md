<!-- repository: packages/ts/contracts | kind: PACKAGE | stack: ts-package -->

# contracts — Skill: Package Development

> Workflow for contracts (packages/ts/contracts). Execute this workflow before, during, and
...
- This package is published (`@omnixys/contracts-ts`); consumers pin versions and rely on SemVer.
